...
Alladin = media.Movie("Alladin",
                      "Young Aladdin embarks on a magical adventure"
                      "after finding a lamp that releases a"
                      "wisecracking genie.",
                      "Alladin.jpg",
...
Avengers = media.Movie("Avengers",
                       ...
                       "Tony sends message to Pepper potts"
...
stm = media.Movie("Sarvam Thalam Mayam",
                  ...
                  "and enter the gates of the Carnatic music world"
                  "hitherto dominated by brahmins.",
                  "stm.jpg",
